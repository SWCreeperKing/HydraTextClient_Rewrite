        ...
        while (convertQueue.Count > 0)
        {
            ...
            switch (layout.Type)
            {
                case "tabbed":
                    ...
                    if (layout.Title is null or "") continue;
                ...
                default:
                    ...
                    if (layout.Title is not null && layout.Content.Length == 1
                                                 && layout.Content[0].Type is not null)
                        // i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker i hate poptracker 
                    {
                        var real = layout.Content[0];
                        if (real.Title is null or "") real.Title = layout.Title;
                        convertQueue.Enqueue((real, parent));
                        continue;
                    }
